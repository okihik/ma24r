...
hist_log_food_waste <- 
  ...
  geom_histogram(aes(y = after_stat(density)), 
                 bins = 30,colour = 1, fill = "white") +
  geom_density(linewidth = 1.5, colour = 4, fill = 4, alpha = 0.15) +
  labs(title = "Logged Food Waste - Histogram")
hist_log_food_waste
...
hist_log_solid_waste <- 
  ...
  geom_histogram(aes(y = after_stat(density)), 
                 bins = 30,colour = 1, fill = "white") +
  geom_density(linewidth = 1.5, colour = 4, fill = 4, alpha = 0.15) +
  labs(title = "Logged Solid Food Waste - Histogram")
hist_log_solid_waste
...
hist_liquid_waste <- 
  ...
  geom_histogram(aes(y = after_stat(density)), 
                 bins = 30,colour = 1, fill = "white") +
  geom_density(linewidth = 1.5, colour = 4, fill = 4, alpha = 0.15) +
  labs(title = "Logged Liquid Food Waste - Histogram")
hist_liquid_waste
...
# Food waste ------------
ggqqplot(subset(log(df$food_waste_kg+1), 
                df$is_closed %in% FALSE)) +
  xlab("theoretical") + ylab("sample") +
  ggtitle("QQ plot of logged Food Waste in kg")

# Solid Food waste ------------
ggqqplot(subset(log(df$solid_waste_kg+1), 
                df$is_closed %in% FALSE)) +
  xlab("theoretical") + ylab("sample") +
  ggtitle("QQ plot of Logged Solid Food Waste in kg")

# Liquid Food waste ------------
ggqqplot(subset(log(df$liquid_waste_kg+1), 
                df$is_closed %in% FALSE)) +
  xlab("theoretical") + ylab("sample") +
  ggtitle("QQ plot of Logged Liquid Food Waste in kg")
```
