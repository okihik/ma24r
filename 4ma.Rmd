...
rdt_fw_log <- log_food_waste_kg ~ container + time +
...
rdt_sfw_log <- log_solid_waste_kg ~ container + time  +
                                      temp_c + humi_p + prcp_mm + 
                                      liquors + sales + halfs +
                                      tueE + wedE+ thuE+ friE+ satE+
                                      I(t_01^2) + I(t_01^3)
...
rdt_lfw_log <- log_liquid_waste_kg ~ container + time  +
                                      temp_c + humi_p + prcp_mm + 
                                      liquors + sales + halfs +
                                      tueE + wedE+ thuE+ friE+ satE+
                                      I(t_01^2) + I(t_01^3)
